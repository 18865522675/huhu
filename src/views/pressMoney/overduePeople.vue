	                    ...
	                    <el-table
	                        ...
	                        <el-table-column
	                            ...
	                            <template slot-scope="scope">
	                                {{scope.row.pressMoneyManName?scope.row.pressMoneyManName:'-----'}}
	                            </template>
	                        </el-table-column>
	                        <el-table-column
	                                prop="gmtDatetime"
                    ...
                    <div class="form-body">
                        <el-form ref="jieqingForm" :model="jieqingForm"  :rules="rules" label-width="100px" class="demo-ruleForm">
                            ...
                            <el-form-item label="其中滞纳金" prop="overMoney">
                                <el-input v-model.trim="jieqingForm.overMoney" auto-complete="new-password" placeholder="请输入其中滞纳金">
                                    <template slot="append">元</template>
                                </el-input>
                            </el-form-item>
            ...
            <div>
                <div class="form-body">
                    <el-form ref="xuqiForm" :model="xuqiForm"  :rules="xuqiRules" label-width="100px" class="demo-ruleForm">
                        ...
                        <el-form-item label="续期总金额" prop="money">
                            <el-input v-model.trim="xuqiForm.money" auto-complete="new-password" placeholder="请输入续期总金额">
                                <template slot="append">元</template>
                            </el-input>
                        </el-form-item>
                        ...
                        <!--</el-form-item>-->
                        <el-form-item label="密码" prop="password">
                            <el-input v-model.trim="xuqiForm.password" auto-complete="new-password"  type="password" placeholder="请输入续期密码">
                            </el-input>
                        </el-form-item>
                    </el-form>
                </div>
    ...
    methods: {
      ...
      multiAction(type){
        ...
        if(type==1){
          ...
          return this.$toolkit.showConfrim('确定要将选中用户进行回退操作嘛?','回退').then(()=>{
      ...
      getOverduePeoples(){
        this.$api.pressMoney.getOverduePeoples({
          ...this.tableForm,
