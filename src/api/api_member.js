...
export default {
  ...
  //获取企业会员
  getEnderPriseList: params => $.get("/user/selectUserList", params, { lock: true }),

  //获取企业会员渠道商
  getVipChannelList: params => $.get("/channel/selectAll", params, { lock: true }),
  //获取企业会员渠道商
  resetPas: params => $.get("/user/resetPassword", params, { lock: true }),
  //企业会员拉黑
  memberSetBlack: params => $.get("/user/black", params, { lock: true }),
